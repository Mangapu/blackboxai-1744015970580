...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($suratController->addSuratKeluar($nomor_surat, $tanggal, $perihal, $tujuan)) {
        $success = 'Surat keluar berhasil ditambahkan';
    } else {
        $error = 'Gagal menambahkan surat keluar. Nomor surat mungkin sudah ada.';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Input Surat Keluar - Kecamatan Masama</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nomor_surat" name="nomor_surat" required
                                ...
                                placeholder="Contoh: 001/UK/MASAMA/2023">
                        </div>
                        <div>
